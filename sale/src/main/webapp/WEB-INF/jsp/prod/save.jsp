...
<head>
	...
	<link rel="stylesheet" type="text/css" media="screen" href="/resources/vendor/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css">
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										...
										<input type="text" id="prodCode" name="prodCode" class="form-control" value="${prodVO.prodCode !=null ? prodVO.prodCode : param.prodCode}" disabled="disabled"/>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<input type="text" id="price" name="price" class="form-control" value="${prodVO.prodName !=null ? prodVo.price : 0}" maxlength="10"  style="text-align: right" numberOnly/>
									</div> 
									<div class="form-group">
										<label for="unitPrice" class="">단가</label> 
										<input type="text" id="unitPrice" name="unitPrice" class="form-control" value="${prodVO.unitPrice !=null ? prodVo.unitPrice : 0}" maxlength="10" style="text-align: right" numberOnly/>
									</div> 
									<div class="form-group">
								...
								<div class="col-sm-6">
									...
									<div class="form-group">
										...
										<input type="text" id="weight" name="weight" class="form-control" value="${prodVO.weight !=null ? prodVo.weight : 0}" maxlength="15"/>
										<label for="model">Height(cm)</label> 
										<input type="text" id="height" name="height" class="form-control" value="${prodVO.height !=null ? prodVo.height : 0}" maxlength="15"/>
									</div> 
									<div class="form-group">
