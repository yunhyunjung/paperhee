          ...
          <input type="submit" form="altEditor-form" class="btn btn-primary"></input>\
                ...
                _openEditModal : function() {
                  ...
                  for ( var j in columnDefs) {
                    ...
                    // Adding select-fields
                    // Adding readonly-fields
                    if (columnDefs[j].type.includes("datetime")) {
                      data += "<input type='text' id='datetimepicker' " 
                          + "name='"
                          + columnDefs[j].title
             ...
             <button type='button' data-content='remove' class='btn btn-primary' id='editRowBtn'>Submit</button>");
                ...
                _editRowData : function() {
                  ...
                  updateJSON(comepleteJsonData, that, "editRow",url);
                },
           ...
           <button type='button'  data-content='remove' class='btn btn-danger' id='deleteRowBtn'>Delete</button>");
                ...
                _deleteRow : function() {
                  ...
                  var url = dt.init().deleteUrl;

                  // Calling AJAX with data, tableObject, command.
                  updateJSON(comepleteJsonData, that, "deleteRow", url);
                ...
                _openAddModal : function() {
                  ...
                  for (var j in columnDefs) {
                    ...
                    //datepicker
                    if (columnDefs[j].type.includes("datetime")) {
                      data += "<input type='text' id='datetimepicker2' " 
                          + "name='"
                          + columnDefs[j].title
                  ...
                  //data += "<script type='text/javascript'>"
              	  data += "<script type=\"text/javascript\">"
              	  data += " $(function (){"
              	  data += " $('#datetimepicker2').datepicker({ language: 'ko', enableOnReadonly:\"true\"}); "
                  //data += "$(document).find('input[name=\"updated_date\"]').removeClass('hasDatepicker').datepicker();});</script>"
              	  data += "});"
              	  data += "</script>"	  
                ...
                _addRowData : function() {
                  ...
                  comepleteJsonData.data.push(rowDataArray);
                  var url = dt.init().addUrl;
                  
                  if (url =='undefined'){
                	  return false;
                  }
                  // Calling AJAX with data, tableObject, command.
                  updateJSON(comepleteJsonData, that, "addRow", url);
